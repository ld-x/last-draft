...
var _src26 = require('./plugins/draft-js-video-plugin/src/');

var _src27 = _interopRequireDefault(_src26);
...
var videoDecorator = (0, _src.composeDecorators)(resizeablePlugin.decorator, focusPlugin.decorator);

var videoPlugin = (0, _src27.default)({ decorator: videoDecorator });

/* init the plugins */
var pluginList = (_pluginList = {
...
}, _defineProperty(_pluginList, 'stickerPlugin', stickerPlugin), _defineProperty(_pluginList, 'videoPlugin', videoPlugin), _pluginList);

var Final = function (_Component) {
  _inherits(Final, _Component);

  _createClass(Final, null, [{
    key: 'defaultProps',
    get: function get() {
      return {
  ...
  function Final(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Final.__proto__ || Object.getPrototypeOf(Final)).call(this, props));
    ...
    if (props.initialState.type === 'raw') {
      STATE = _this.getStateFromRaw(props.initialState.content);
    } else if (props.initialState.type === 'html') {
      STATE = _this.getStateFromHtml(props.initialState.content);
    } else if (props.initialState.type === 'text') {
      STATE = _this.getStateFromText(props.initialState.content);
    }
  ...
  _createClass(Final, [{
    key: 'getStateFromRaw',
    value: function getStateFromRaw(raw) {
      var content = (0, _draftJs.convertFromRaw)(raw);
      var STATE = _draftJs.EditorState.createWithContent(content);
      return STATE;
    }
  }, {
    key: 'getStateFromHtml',
    value: function getStateFromHtml(html) {
      var content = _draftJs.ContentState.createFromBlockArray((0, _draftJs.convertFromHTML)(html));
      var STATE = _draftJs.EditorState.createWithContent(content);
      return STATE;
    }
  }, {
    key: 'getStateFromText',
    value: function getStateFromText(text) {
      var STATE = (0, _src.createEditorStateWithText)(text);
      return STATE;
    }
  }, {
    key: 'logState',
    ...
    value: function getPlugins() {
      ...
      if (this.props.plugins.includes('imagePlugin') || this.props.plugins.includes('videoPlugin')) {
