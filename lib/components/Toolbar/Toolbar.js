...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function setSideBarPosition() {
      var container = _reactDom2.default.findDOMNode(this.refs.sidebar);
      ...
      var bottom = Math.abs(element.getBoundingClientRect().top - 4 - containerBottom);
    ...
    value: function renderButton(item, position) {
      ...
      return _react2.default.createElement(_ToolbarButton.ToolbarButton, { theme: theme, key: key, active: active, toggle: toggle, item: item });
    }
  }, {
    key: 'renderToolList',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          Sidebar,
          { ref: 'sidebar', className: 'ld-sidebar' },
          _react2.default.createElement(
            SidebarMenuWrapper,
            { style: { bottom: this.state.sidebarBottom - 30 + 'px' }, className: 'ld-sidebar-menu-wrapper' },
...
var Sidebar = _styledComponents2.default.div(_templateObject5);

var SidebarMenuWrapper = _styledComponents2.default.div(_templateObject6);