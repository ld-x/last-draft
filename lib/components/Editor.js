      ...
      if (file.type.indexOf('image/') === 0) {
        if (uploadImageCallBack !== undefined) {
          uploadImageCallBack(file).then(function (data) {
            ...
            _this2.onChange((0, _insertDataBlock2.default)(_this2.props.editorState, imageData, selection));
          });
        } else {
          var src = URL.createObjectURL(file);
          var imageData = { src: src, type: "image" };
          this.onChange((0, _insertDataBlock2.default)(this.props.editorState, imageData, selection));
        }
      }
    }
  }, {
