...
var _default = function (_Component) {
  ...
  function _default(props) {
    ...
    _this.actions = _actions2.default;
  ...
  _createClass(_default, [{
    ...
    value: function blockRendererFn(block) {
      ...
      if (block.getType() === 'alignment-left') {
        return { component: _Alignment2.default, props: { alignment: 'flex-start' } };
      }
      ...
      if (block.getType() === 'alignment-right') {
        return { component: _Alignment2.default, props: { alignment: 'flex-end' } };
      }
