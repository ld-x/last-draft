...
var _default = function (_Component) {
  ...
  function _default(props) {
    ...
    _this.displaySidebar = _this.displaySidebar.bind(_this);
    ...
    _this.allActions = _this.getActions();
  ...
  _createClass(_default, [{
    ...
    key: 'displaySidebar',
    value: function displaySidebar(editorState) {
    ...
    key: 'closeSidebar',
    value: function closeSidebar(editorState) {
      this.setState({ sidebarOpen: false });
      this.setAllActions();
    }
  }, {
    key: 'setAllActions',
    value: function setAllActions() {
      this.actions = this.allActions;
    }
  }, {
    key: 'setActionsToPlugins',
    value: function setActionsToPlugins() {
      var newActions = [];
      ...
      try {
        for (var _iterator7 = this.allActions[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
    ...
    value: function autocompleteKeyBinding(event, searchChar) {
      ...
      if (focusOffset > charOffset) {
        ...
        if (event.keyCode >= 48 && event.keyCode <= 57 || event.keyCode >= 65 && event.keyCode <= 90 || event.keyCode === 8 || event.keyCode === 32) {
          ...
          if (searchValue.split(' ').length - 1 > 2) {
            return;
          }
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          maxLeftOffset = _props2.maxLeftOffset,
          toolbarHeight = _props2.toolbarHeight;
