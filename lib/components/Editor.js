...
var _MentionList = require('./Mentions/MentionList');

var _MentionList2 = _interopRequireDefault(_MentionList);
...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    key: 'hideMentionsOnMove',
    value: function hideMentionsOnMove(editorState) {
      ...
      if (focusOffset !== mentionCurrentOffset) {
    ...
    key: 'showMentionsKeyBinding',
    value: function showMentionsKeyBinding(event) {
      var _props2 = this.props,
          editorState = _props2.editorState,
          mentionUsers = _props2.mentionUsers,
          mentionUsersAsync = _props2.mentionUsersAsync;
      ...
      var text = block.text;
      var focusOffset = selectionState.getFocusOffset();
      var mentionSearchValue = null;
      var lastMentionOffset = null;
      ...
      if (focusOffset > lastMentionOffset) {
        ...
        if (event.keyCode >= 48 && event.keyCode <= 57 || event.keyCode >= 65 && event.keyCode <= 90 || event.keyCode === 8 || event.keyCode === 32) {
          var textLength = focusOffset - lastMentionOffset;
          var mentionText = text.substr(lastMentionOffset, textLength);
          if (event.keyCode === 8) {
    ...
    value: function renderMentionList(props) {
      var _props3 = this.props,
          mentionUsersAsync = _props3.mentionUsersAsync,
          mentionUsers = _props3.mentionUsers;

      if (mentionUsers === undefined && mentionUsersAsync === undefined) {
        return null;
      }
      return _react2.default.createElement(_MentionList2.default, props);
    }
  }, {
    key: 'uploadFile',
    value: function uploadFile(file, selection) {
      ...
      var _props4 = this.props,
          uploadImageAsync = _props4.uploadImageAsync,
    ...
    value: function render() {
      var _props5 = this.props,
          ...
          stripPastedStyles = _props5.stripPastedStyles,
          spellCheck = _props5.spellCheck,
          theme = _props5.theme,
          separators = _props5.separators;
