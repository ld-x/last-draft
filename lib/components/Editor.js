...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function getValidPlugins() {
      ...
      try {
        for (var _iterator6 = _plugins2.default[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      ...
      try {
        for (var _iterator7 = this.props.plugins[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          var _plugin = _step7.value;

          if (!_plugin || typeof _plugin.type !== 'string') {
            console.warn('Plugin: Missing type field: ', _plugin);
            continue;
          }
    ...
    value: function keyBindingFn(e) {
      ...
      try {
        for (var _iterator9 = this.keyBindings[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
          var kb = _step9.value;
