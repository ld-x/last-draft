...
var _MentionList = require('./MentionList/MentionList');

var _MentionList2 = _interopRequireDefault(_MentionList);

var _EmojiList = require('./EmojiList/EmojiList');
...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function hideAutocompleteOnMove(editorState) {
      ...
      if (mentionUsers === undefined && mentionUsersAsync === undefined && plugins.emoji === undefined) {
        return;
      }
    ...
    value: function renderMentionList(props) {
      var _props4 = this.props,
          mentionUsersAsync = _props4.mentionUsersAsync,
          mentionUsers = _props4.mentionUsers;
    ...
    value: function renderEmojiList(props) {
      var plugins = this.getPluginsByType();
      if (plugins.emoji !== undefined) {
        return _react2.default.createElement(_EmojiList2.default, props);
      }
      return null;
    }
  }, {
    ...
    value: function uploadFile(file, selection) {
      ...
      var _props5 = this.props,
          uploadImageAsync = _props5.uploadImageAsync,
    ...
    value: function render() {
      var _props6 = this.props,
          ...
          stripPastedStyles = _props6.stripPastedStyles,
          spellCheck = _props6.spellCheck,
          theme = _props6.theme,
          separators = _props6.separators;
