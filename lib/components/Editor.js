...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function getActions() {
      ...
      try {
        for (var _iterator2 = this.props.blocks[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          var _action = this.getAction(block);
    ...
    value: function getValidPlugins() {
      ...
      try {
        for (var _iterator5 = _plugins2.default[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
