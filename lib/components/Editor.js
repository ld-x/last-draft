  ...
  _createClass(_default, [{
    ...
    value: function showMentionsKeyBinding(event) {
      ...
      if (block.text.includes('@')) {
        var lastMentionOffset = text.lastIndexOf('@');
        ...
        if (focusOffset > lastMentionOffset) {
          ...
          if (event.keyCode >= 48 && event.keyCode <= 57 || event.keyCode >= 65 && event.keyCode <= 90 || event.keyCode === 8) {
            var mentionText = text.substr(lastMentionOffset, focusOffset);
            if (event.keyCode === 8) {
    ...
    value: function uploadFile(file, selection) {
      ...
      var _props3 = this.props,
          uploadImageAsync = _props3.uploadImageAsync,
    ...
    value: function render() {
      var _props4 = this.props,
          ...
          stripPastedStyles = _props4.stripPastedStyles,
          spellCheck = _props4.spellCheck,
          theme = _props4.theme,
          separators = _props4.separators;
