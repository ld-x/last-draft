...
var _default2 = require('../actions/default');
...
var _blockRenderMap = require('./blockRenderMap');

var _blockRenderMap2 = _interopRequireDefault(_blockRenderMap);
...
var _default = function (_Component) {
  ...
  function _default(props) {
    ...
    _this.actions = _this.props.actions || _default3.default;
    _this.plugins = _this.getValidPlugins();
    _this.entityInputs = _this.props.entityInputs || _entities2.default;
  ...
  _createClass(_default, [{
    ...
    value: function getValidPlugins() {
      ...
      try {
        for (var _iterator = (this.props.plugins || _plugins2.default)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: function handleDroppedFiles(selection, files) {
      ...
      if (uploadImageCallBack !== undefined) {
        ...
        var imageData = { src: src, type: 'image' };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'editor', ref: 'editor', className: 'final-editor' },
          this.renderSidebar({
            plugins: plugins,
          ...
          _react2.default.createElement(_draftJs.Editor, {
            readOnly: this.state.readOnly,
            plugins: plugins,
            blockRenderMap: _blockRenderMap2.default,
