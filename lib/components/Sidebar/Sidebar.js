...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      if (this.props.sidebarVisibleOn === 'never') {
        return null;
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_SideMenu2.default, {
            ...
            closeSidebar: (_context = this.props).closeSidebar.bind(_context),
            openSidebar: (_context = this.props).openSidebar.bind(_context),
