      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_Buttons2.default.CrossIcon, null)
          ),
          _react2.default.createElement(
            SideMenuItems,
            { style: menuItemsStyle, className: 'ld-sidemenu-items' },
            this.props.plugins.map(function (item) {
              var Button = item.button;
              return _react2.default.createElement(
                SideMenuItem,
                { key: item.type, className: 'ld-sidemenu-item' },
...
var SideMenuItems = _styledComponents2.default.ul(_templateObject3, function (props) {
  return props.open ? '116px' : 0;
}, function (props) {
  return props.open ? 1 : 0;
});

var SideMenuButton = _styledComponents2.default.button(_templateObject4, function (props) {
  return props.open ? 'rotate(45deg)' : 'none';
}, function (props) {
  return props.theme.color;
}, function (props) {
  return props.open ? props.theme.highlight : props.theme.backgroundColor;
});

var SideMenuItem = _styledComponents2.default.li(_templateObject5);