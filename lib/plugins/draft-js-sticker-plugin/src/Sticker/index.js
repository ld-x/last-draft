...
var Sticker = function (_Component) {
  ...
  function Sticker() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Sticker.__proto__ || Object.getPrototypeOf(Sticker)).call.apply(_ref, [this].concat(args))), _this), _this.remove = function (event) {
