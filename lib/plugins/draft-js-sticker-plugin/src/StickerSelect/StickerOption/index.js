...
var StickerOption = function (_Component) {
  ...
  function StickerOption() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = StickerOption.__proto__ || Object.getPrototypeOf(StickerOption)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function () {
