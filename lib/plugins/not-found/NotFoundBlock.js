...
var NotFoundBlock = function (_Component) {
  ...
  function NotFoundBlock(props) {
    ...
    _this.actions = [{
      key: 'delete',
      icon: _icons2.default.DeleteIcon,
  ...
  _createClass(NotFoundBlock, [{
    ...
    value: function render() {
      var message = 'Cannot show plugin, component ' + this.props.data.type + ' not found.';
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_icons2.default.ErrorIcon, null)
        )
      );
    }
  }]);
