...
function editorStateToHtml(editorState) {
  if (editorState) {
    var _ret = function () {
      ...
      var exportColors = Object.keys(_styleMap2.default).map(function (name) {
        var colorStyle = _styleMap2.default[name].color ? 'color: ' + _styleMap2.default[name].color : '';
        return Object.assign({}, _defineProperty({}, name, {
          element: 'span',
