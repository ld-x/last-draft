...
function editorStateToHtml(editorState) {
  if (editorState) {
    var _ret = function () {
      ...
      var convertedHTMLwithLinks = linkifyMatch.filter(function (match) {
      ...
      var hashtifyMatch = (0, _hashtag.extractHashtagsWithIndices)(convertedHTMLwithLinks);
      return {
        v: hashtifyMatch.reduce(function (current, match) {
