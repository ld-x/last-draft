...
/*
 * Copyright (c) 2016, HubSpot (https://github.com/HubSpot/draft-convert)
 * v1.4.2
 * License: MIT
 */
...
var getSafeBodyFromHTML = function parseHTML(html) {
  var doc = void 0;
...
function genFragment(node, inlineStyle, lastList, inBlock, fragmentBlockTags, depth, processCustomInlineStyles, checkEntityNode, checkEntityText, checkBlockType, options, inEntity) {
  ...
  if (nodeName === '#text') {
    var _ret2 = function () {
      ...
      var offsetChange = 0;
      var textEntities = checkEntityText(text).sort(rangeSort);
